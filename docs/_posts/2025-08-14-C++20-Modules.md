...
- [构建系统](#----)
- [C++20 Modules 能减少多少编译时间？](#c--20-modules-----------)
- [C++20 Modules 和 PCH 是等价的吗？区别是什么？](#c--20-modules---pch-------------)
- [C++20 Modules 能减少代码体积吗？为什么？](#c--20-modules--------------)
- [我们现在可以使用 C++20 Modules 编程吗？](#---------c--20-modules-----)
  * [但代价是什么呢？](#--------)
  * [能使用 C++20 Modules 编程的场合](#----c--20-modules------)
- [Modules Wrapper](#modules-wrapper)
- [C++20 Modules 是怎么减少编译时间的？](#c--20-modules------------)
  * [前端和编译期计算](#--------)
  * [中后端](#---)
  * [Modules 对编译速度带来的负面影响](#modules-------------)
- [修改接口文件导致的重编译问题](#--------------)
- [Module Implementation Partition Unit 的其他用途](#module-implementation-partition-unit------)
- [非传递式改变](#------)
- [尽量避免在不同 TU 中存放相同的声明](#--------tu---------)
- [Modules 对代码体积的影响](#modules---------)
- [Modules 改造过程中遇到的运行时问题](#modules--------------)
- [Modules 中的前置声明问题](#modules---------)
- [TODO？](#todo-)
