...
- [How much compile time can C++20 Modules save?](#how-much-compile-time-can-c--20-modules-save-)
- [Are C++20 Modules and PCH equivalent? What's the difference?](#are-c--20-modules-and-pch-equivalent--what-s-the-difference-)
- [Can C++20 Modules reduce code size? Why?](#can-c--20-modules-reduce-code-size--why-)
- [Can we use C++20 Modules for programming now?](#can-we-use-c--20-modules-for-programming-now-)
  * [But what's the cost?](#but-what-s-the-cost-)
  * [When to use C++20 Modules](#when-to-use-c--20-modules)
- [Modules Wrapper](#modules-wrapper)
- [How do C++20 Modules reduce compile time?](#how-do-c--20-modules-reduce-compile-time-)
